...
function Testimonials() {
    return (
        <div className={`${testimonialCSS.testimonial_wrapper} section`}>
            ...
            <h2 className='section_Title'>Near <span>Ramnagar</span></h2>
            <Swiper
                slidesPerView={1}
                spaceBetween={30}
                loop={true}
            ...
            >
                <SwiperSlide>
                    <div className={testimonialCSS.testimonial}>
                        ...
                        <div className={testimonialCSS.content}>
                            <h3>Corbett National Park,<span>Ramnagar</span></h3>
                ...
                <SwiperSlide>
                    <div className={testimonialCSS.testimonial}>
                        <img src={img5} alt='' />
                        <div className={testimonialCSS.content}>
                            <h3>Corbett Tiger Reserve Museum,<span>Ramnagar</span></h3>
                ...
                <SwiperSlide>
                    <div className={testimonialCSS.testimonial}>
                        <img src={img3} alt='' />
                        <div className={testimonialCSS.content}>
                            <h3>Garjiya Devi,<span>Ramnagar</span></h3>
                ...
                <SwiperSlide>
                    <div className={testimonialCSS.testimonial}>
                        <img src={img4} alt='' />
                        <div className={testimonialCSS.content}>
                            <h3>Corbett Fall,<span>Ramnagar</span></h3>
                ...
                <SwiperSlide>
                    <div className={testimonialCSS.testimonial}>
                        <img src={img1} alt='' />
                        <div className={testimonialCSS.content}>
                            <h3>British Pull,<span>Ramnagar</span></h3>
